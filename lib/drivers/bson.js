 ...
 * ```
 */
module.exports = class BSONDatabase extends EventEmitter {
    /**
    ...
    delete(key) {
        ...
        if (del) this.emit('delete', ...arguments);
        write(this[kOptions], data);
    ...
    concat(key) {
        ...
        return this.insert(key, Array.prototype.concat.call(data, ...[...arguments].slice(1)));
    }
